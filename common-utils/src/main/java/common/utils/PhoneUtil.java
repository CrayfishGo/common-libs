...
public class PhoneUtil {
    ...
    public static final String REGEX_GET_MOBILE_CODE =
            "(?is)(<tr[^>]+>[\\s]*<td[^>]+>[\\s]*区 号[\\s]*</td>[\\s]*<td[^>]+>([^<]+)</td>[\\s]*</tr>)";
    ...
    public static String getMobileFrom(String mobileNumber) throws Exception {
        ...
        try {
            ...
            method = new GetMethod("/search.asp");
            ...
            method.setQueryString((new NameValuePair[]{actionParameter, mobileParameter}));
            //设置编码
    ...
    public static String parseMobileFrom(String htmlSource) {
        htmlSource = htmlSource.replaceAll("gb2312", "utf-8");
        Pattern p = null;
        Matcher m = null;
        String result = null;
    ...
    public static void main(String[] args) throws Exception {
        //  String result=getMobileFrom("15158053827");
        ///  System.out.println(result);
        //  System.out.println(getMobileFrom("13107714077"));
        String code = "431128199011040424";
        String reg = "^(.{4}).*$";
